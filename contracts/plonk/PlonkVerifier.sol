...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 16424822917133113238440275348519027879839628771157729723956686546006017491118;
  uint256 private constant G2_SRS_1_X_1 = 9213244272033992671284636204705614312581755709698799595155294646837454585127;
  uint256 private constant G2_SRS_1_Y_0 = 15455456920279720973581315588829775575927929264055813535397766041613023365150;
  uint256 private constant G2_SRS_1_Y_1 = 16002680788609480268612795281230412790405471822819535700138077693675866852556;
  ...
  uint256 private constant VK_QL_COM_X = 17196000593382222193172204777775023460320929752615964713615437574252489883269;
  uint256 private constant VK_QL_COM_Y = 10446232697379283197282488943440283788813680487018042670565505761534029040065;
  uint256 private constant VK_QR_COM_X = 344709022224732246558619763515408735192423904037904225379278197197837256534;
  uint256 private constant VK_QR_COM_Y = 17917577916585755085355109695668411714998174024684008941001182154733395340045;
  uint256 private constant VK_QM_COM_X = 18978463487710009191946285940345150906073622043882676353401439717524035294148;
  uint256 private constant VK_QM_COM_Y = 7023785754731658343495022549170331751996643028975860352783967388630847459994;
  uint256 private constant VK_QO_COM_X = 17731619071757856064528434516392869166703202514812782166803263410806431645400;
  uint256 private constant VK_QO_COM_Y = 21243001393576158368737041457398629075839972698310073821651024003370981881481;
  uint256 private constant VK_QK_COM_X = 14329054754322092040566053539036351674505013697996672243423122253673407612299;
  uint256 private constant VK_QK_COM_Y = 21407105412542473021843531018006404012091839283957201762785189899057973493213;
  
  uint256 private constant VK_S1_COM_X = 9903944200997269253175516210233847374817719058523315434276248181480773259892;
  uint256 private constant VK_S1_COM_Y = 17310757757520689138565777254733233488878693579577685437877442626630813119083;
  
  uint256 private constant VK_S2_COM_X = 12237312322497676129279859504949874773218077837630659375630787964529042788229;
  uint256 private constant VK_S2_COM_Y = 21616708196655123618126473508543623524322797599181688245861283777038644164397;
  
  uint256 private constant VK_S3_COM_X = 2664508501389324046786163479404186398138901333380284990839538675568788407515;
  uint256 private constant VK_S3_COM_Y = 14063267217769176410598251110564604675748895277244091717214803581329804490646;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 21835576117166500233152389195424386293158662065795025634293074571624452299738;
  uint256 private constant VK_QCP_0_Y = 2618231123310363996983392058871801571460416018621425682933551535557034124685;
  ...
  // -------- utils (for hash_fr)
    ...
    function Verify(bytes calldata proof, uint256[VK_NB_PUBLIC_INPUTS] calldata public_inputs) public view returns (bool success) {
    assembly {
      ...
      let l_wocommit := sum_pi_commit(proof.offset, 3, freeMem)
