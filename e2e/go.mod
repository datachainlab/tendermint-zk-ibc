module github.com/datachainlab/tendermint-zk-ibc/e2e

go 1.21

require github.com/datachainlab/tendermint-zk-ibc/go v0.0.0

replace github.com/datachainlab/tendermint-zk-ibc/go => ../go
